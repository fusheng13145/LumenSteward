 ...
 *
 * <p>实现领域端口 {@link com.lumensteward.clawbot.domain.port.VoiceSynthesisPort}（上提自原
 * {@code TtsClient} 接口）。返回确定性字节序列（非真实音频），供联调断言链路；真实 TTS 在后续迭代接入。
 */
@Component
public class MockTtsClient implements VoiceSynthesisPort {
